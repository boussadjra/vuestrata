...
user-invocable: true
argument-hint: '(optional) Specific area to focus on (accessibility, performance, theming, responsive, anti-patterns, or all) or specific component or page to audit'
---
