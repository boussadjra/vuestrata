...
const minValue = computed(() => {
  ...
  return toDateValue(new Date(props.min), {
    includeTime: includeTime.value,
    timeZone: props.timeZone,
  })
})
...
const maxValue = computed(() => {
  ...
  return toDateValue(new Date(props.max), {
    includeTime: includeTime.value,
    timeZone: props.timeZone,
  })
})
  ...
  <div class="flex flex-col gap-1">
    ...
    >
      <DatePickerField v-slot="{ segments }" class="flex items-center gap-1">
        <div :class="controlClasses" data-ui="date-picker" data-provider="reka">
          <DatePickerInput
        ...
        <DatePickerTrigger
          ...
          :aria-label="props.label ?? t('common_pick_date')"
        >
          📅
        </DatePickerTrigger>
      </DatePickerField>
