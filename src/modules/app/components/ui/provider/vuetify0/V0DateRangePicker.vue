...
import V0DatePicker from './V0DatePicker.vue'
...
const props = withDefaults(defineProps<DateRangePickerProps>(), { size: 'md' })
...
<template>
  <div class="flex flex-col gap-1">
    ...
    <div class="flex items-center gap-2" data-provider="vuetify0" data-ui="date-range-picker">
      <V0DatePicker
        :model-value="start"
        :disabled="disabled"
        :readonly="readonly"
