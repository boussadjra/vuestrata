...
<template>
  <div data-provider="reka">
    <div
      :class="[
        'flex cursor-pointer items-center gap-1 rounded-md px-2 py-1.5 text-sm select-none',
...
<script lang="ts">
// Self-referencing recursive component name
export default { name: 'RekaTreeNode' }
</script>
